                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("componentview.yacl.option.boolean.verboseLogging"))
                                        .description(OptionDescription.of(Text.translatable("componentview.yacl.option.boolean.verboseLogging.desc")))
