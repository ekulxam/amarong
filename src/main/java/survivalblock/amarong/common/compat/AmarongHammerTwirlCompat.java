...
public class AmarongHammerTwirlCompat {
    ...
    public static void whack(PlayerEntity player) {
        ...
        AmarongUtil.getEntities(serverWorld, entity -> AmarongUtil.getProperlyScaledBox(player).expand(2).intersects(AmarongUtil.getProperlyScaledBox(entity)), entities);
