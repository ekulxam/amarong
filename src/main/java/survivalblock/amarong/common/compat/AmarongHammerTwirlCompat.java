...
public class AmarongHammerTwirlCompat {
    ...
    public static void whack(PlayerEntity player) {
        ...
        serverWorld.atmospheric_api$getAndAddEntitiesToCollection(entity -> AmarongUtil.getProperlyScaledBox(player).expand(2).intersects(AmarongUtil.getProperlyScaledBox(entity)), entities);
