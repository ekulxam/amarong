...
public class AmarongEntityTypes {
    ...
    public static final EntityType<PhasingBoomerangEntity> BOOMERANG = registerEntity("amarong_boomerang", EntityType.Builder.<PhasingBoomerangEntity>create(PhasingBoomerangEntity::new, SpawnGroup.MISC).dimensions(1F, 0.0625F).trackingTickInterval(20).makeFireImmune());
