...
public class AmarongTags {
    ...
    public static class AmarongDamageTypeTags {
        public static final TagKey<DamageType> BYPASSES_CREATIVE = TagKey.of(RegistryKeys.DAMAGE_TYPE, Amarong.id("bypasses_creative"));
    }
}
