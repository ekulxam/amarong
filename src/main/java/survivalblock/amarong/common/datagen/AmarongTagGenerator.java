...
public class AmarongTagGenerator {
    ...
    public static class AmarongDamageTypeTagGenerator extends FabricTagProvider<DamageType> {
        ...
        @Override
        protected void configure(RegistryWrapper.WrapperLookup lookup) {
            getOrCreateTagBuilder(AmarongTags.AmarongDamageTypeTags.BYPASSES_CREATIVE).forceAddTag(DamageTypeTags.BYPASSES_INVULNERABILITY);
            ...
            getOrCreateTagBuilder(AmarongTags.AmarongDamageTypeTags.BYPASSES_CREATIVE).add(AmarongDamageTypes.WATER_STREAM_HIT);
            ...
            getOrCreateTagBuilder(AmarongTags.AmarongDamageTypeTags.BYPASSES_CREATIVE).add(AmarongDamageTypes.RAILGUN_HIT);
    ...
    public static class AmarongEntityTypeTagGenerator extends FabricTagProvider.EntityTypeTagProvider {
        ...
        protected void configure(RegistryWrapper.WrapperLookup lookup) {
            ...
            getOrCreateTagBuilder(AmarongTags.AmarongEntityTypeTags.AMARONG_HITTABLE).addOptionalTag(EntityTypeTags.IMPACT_PROJECTILES);
