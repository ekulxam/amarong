...
public class AmarongEnUsLangGenerator extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add("item.amarong.amarong_hammer.alias", "Alternatively called \"Amarong Core on a Stick\"");
        ...
        translationBuilder.add("enchantment.amarong.pnuematic", "Pnuematic");
        translationBuilder.add("enchantment.amarong.pnuematic.desc", "Allows the Ticket Launcher to launch wind charges from the offhand.");
        ...
        translationBuilder.add("enchantment.amarong.obscure.desc", "Use the Amarong Longsword when fully charged to enter total invisibility temporarily.");
        translationBuilder.add("enchantment.amarong.railgun", "Railcannon");
        translationBuilder.add("enchantment.amarong.railgun.desc", "Use the Amarong Longsword when fully charged to fire off a railcannon.");
        ...
        translationBuilder.add("componentview.yacl.group.client", "Client");
        translationBuilder.add("componentview.yacl.option.boolean.verboseLogging", "Verbose Logging");
        translationBuilder.add("componentview.yacl.option.boolean.verboseLogging.desc", "Logs more information, such as kaleidoscope shaders");

        // damage types
        translationBuilder.add("death.attack.amarong.flying_ticket_hit", "%1$s was shot by flying tickets");
        translationBuilder.add("death.attack.amarong.flying_ticket_hit.player", "%1$s was shot by %2$s with flying tickets");
        translationBuilder.add("death.attack.amarong.water_stream_hit", "%1$s was sprinkled to death");
        translationBuilder.add("death.attack.amarong.water_stream_hit.player", "%1$s was sprinkled to death by %2$s");
        translationBuilder.add("death.attack.amarong.railgun_hit", "%1$s was shot by a railcannon");
